...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { recurring: @reminder.recurring, text_content: @reminder.text_content, title: @reminder.title, trigger_at: @reminder.trigger_at, user_id: @reminder.user_id }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { recurring: @reminder.recurring, text_content: @reminder.text_content, title: @reminder.title, trigger_at: @reminder.trigger_at, user_id: @reminder.user_id }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
